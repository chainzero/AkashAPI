...
func main() {
	// Replace ownerID and DSEQ values in function call template below
...
func deploymentInfo(ownerID, dseq string) {
	...
	DeploymentDetails1 := DeploymentDetails{}

	json.Unmarshal(body, &DeploymentDetails1)

	fmt.Println(DeploymentDetails1)
